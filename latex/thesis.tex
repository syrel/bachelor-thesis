...
To get an idea of how this tool can be useful, take a look at the following example on the \figref{GtTranscriptAnimation}. A Bloc animation is logged in a visual, domain centric way, providing insight far superior to plain text.
